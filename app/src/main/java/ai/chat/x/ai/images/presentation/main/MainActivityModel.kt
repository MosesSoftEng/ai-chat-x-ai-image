...
/**
 * MainActivityModel is responsible for managing the data and business logic related to the main screen of the application.
 * It handles user interactions, data retrieval, and updates to provide a seamless user experience.
 * The MainActivityModel communicates with the domain layer and data layer to execute use cases and fetch necessary data.
